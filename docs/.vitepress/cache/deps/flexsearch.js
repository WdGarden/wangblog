...
function Ma(a, c, b) {
  return c ? typeof module !== "undefined" ? new (require_worker_threads())["Worker"](__dirname + "/worker/node.js") : import("./worker_threads-GIUSICMM.js").then(function(worker) {
